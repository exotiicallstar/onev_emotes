...
Config = {
    ...
    CancelEmoteKey = 'c', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    ...
    MenuImage = "https://letsmate.de/files/iTVqjzr.png", ----[Custom banner IMGUR or GIPHY URLs go here ]---
